...
#QEMUOPTS = -cpu pentium -rtc base=localtime -m 64M -gdb tcp::1234 -kernel kernel.bin -S


# Ensimag
#QEMUOPTS = -cpu pentium -rtc base=localtime -m 64M -kernel kernel.bin
#HOME
QEMUOPTS = -cpu pentium -rtc base=localtime -m 64M -gdb tcp::1234 -kernel kernel.bin &> /dev/null
